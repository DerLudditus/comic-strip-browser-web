#!/usr/bin/env python3
"""
Simple proxy server for Comic Strip Browser To-Go
...
class ProxyHandler(SimpleHTTPRequestHandler):
    ...
    def handle_fetch_comic(self):
        try:
            ...
            # Check if this is a 404 page (GoComics returns 200 status with 404 content)
            # Be very specific to avoid false positives
            if "You've lost the trail!" in html and "404" in html:
